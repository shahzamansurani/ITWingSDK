        ...
        runCatching {
            ...
            attrs?.let {
                ...
                context.withStyledAttributes(
                    it,
                    R.styleable.ITWingNativeAdView
                ) {

                    placementName =
                        getString(
                            R.styleable.ITWingNativeAdView_ITWingNativeAdViewPlacement
                        ) ?: placementName

                    if (
                        hasValue(
                            R.styleable.ITWingNativeAdView_ITWingNativeAdViewType
                        )
                    ) {
                    ...
                    val backgroundColor =
                        getColor(
                            R.styleable.ITWingNativeAdView_ITWingNativeAdViewBackgroundColor,
                            Color.TRANSPARENT
                        )
                    ...
                    val cornerRadius =
                        getDimension(
                            R.styleable.ITWingNativeAdView_ITWingNativeAdViewCornerRadius,
                            0f
                        )
