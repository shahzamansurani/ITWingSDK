...
class InterstitialManager(
    ...
    private val loadedAds =
        ConcurrentHashMap<String, InterstitialAd>()
    ...
    */
    ...
    fun clear(placementName: String) {
        runOnMain { loadedAds.remove(placementName)

            preloaderKeys[placementName]?.let { key ->
    ...
    */
    ...
    private fun pollPreloadedAd(
        ...
        return runCatching {
            ...
            InterstitialAdPreloader.pollAd(
                key
            )
