...
object ITWingSDK {
    ...
    private fun colorLookupKeys(name: String): List<String> {
        ...
        val aliases = when (key) {
            ...
            "banner_cta_color", "banner_cta_background_color" -> listOf(key, "native_cta_color", "native_cta_background_color", "ad_cta_color", "ad_cta_background_color", "primary", "primary_color")
            "ad_cta_color", "ad_cta_background_color" -> listOf(key, "native_cta_color", "native_cta_background_color", "banner_cta_color", "banner_cta_background_color", "primary", "primary_color")
