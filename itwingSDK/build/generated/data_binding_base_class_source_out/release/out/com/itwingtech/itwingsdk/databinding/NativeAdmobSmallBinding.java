...
public final class NativeAdmobSmallBinding implements ViewBinding {
  @NonNull
  ...
  private NativeAdmobSmallBinding(@NonNull NativeAdView rootView, @NonNull TextView adAdvertiser,
  ...
  @NonNull
  public static NativeAdmobSmallBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static NativeAdmobSmallBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.native_admob_small, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static NativeAdmobSmallBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new NativeAdmobSmallBinding((NativeAdView) rootView, adAdvertiser, adAppIcon, adBody,
