...
public final class CustomBannerBinding implements ViewBinding {
  ...
  private CustomBannerBinding(@NonNull LinearLayout rootView, @NonNull TextView adAdvertiser,
      ...
      @NonNull SDKMediaView adMedia, @NonNull RatingBar adStars) {
  ...
  @NonNull
  public static CustomBannerBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static CustomBannerBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.custom_banner, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static CustomBannerBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new CustomBannerBinding((LinearLayout) rootView, adAdvertiser, adAppIcon, adBody,
          adCallToAction, adHeadline, adIc, adMedia, adStars);
    }
