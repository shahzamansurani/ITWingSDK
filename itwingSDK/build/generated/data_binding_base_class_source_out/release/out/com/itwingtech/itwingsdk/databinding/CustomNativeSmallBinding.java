...
public final class CustomNativeSmallBinding implements ViewBinding {
  @NonNull
  ...
  private CustomNativeSmallBinding(@NonNull LinearLayout rootView, @NonNull TextView adAdvertiser,
  ...
  @NonNull
  public static CustomNativeSmallBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static CustomNativeSmallBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.custom_native_small, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static CustomNativeSmallBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new CustomNativeSmallBinding((LinearLayout) rootView, adAdvertiser, adAppIcon, adBody,
          adCallToAction, adHeadline, adIc, adMedia, adPrice, adStars, adStore);
    }
